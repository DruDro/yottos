	...
	<div class="container">
		<main class="main">
				...
				if ( have_posts() ) :
					...
					?>
		        	<p style="text-align:right; margin: 0; padding: 25px 0 0;"><a href="'. get_permalink() .'" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--primary">read more</a></p>
		        	</article>
					<?php endwhile;
        				wp_reset_postdata();
						endif;
